// 信用卡管理 Cloudflare Worker（前端 SPA + D1 API + scheduled 推送），worker.js版本：V3.5.20260905
...
<body class="bg-white text-gray-900">
    ...
    <div class="max-w-md mx-auto min-h-screen bg-white pb-16">
        ...
        <div id="page-main">
            ...
            <div class="grid grid-cols-10 gap-1.5 px-4">
                <div class="bg-gray-200 p-3 rounded-lg text-center col-span-3">
                ...
                <div class="bg-gray-200 p-3 rounded-lg text-center col-span-3">
                    ...
                    <div id="stat-due-in-7" class="text-xl font-bold">0 行</div>
                </div>
                <div class="bg-gray-200 p-3 rounded-lg text-center col-span-4">
            ...
            <div class="px-4 mt-4">
                <div class="relative">
                    ...
                    <input type="search" id="search-bar" class="w-full bg-white border border-gray-300 rounded-lg pl-10 pr-4 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="点此搜索银行名称">
                </div>
            </div>
            ...
            <div class="px-4 mt-4">
                ...
                <div class="grid grid-cols-10 gap-0.5 text-xs text-gray-600 px-3 py-2">
                    <div class="col-span-3">银行/尾号</div>
                    <div class="col-span-2 text-center">账单日</div>
                    <div class="col-span-3 text-center">还款日</div>
                    <div class="col-span-2 text-right">免息期</div>
                </div>
            ...
            <div class="px-4 mt-4 mb-8 text-center text-sm text-gray-500">
                信用卡掌柜V3.5.2026.09.05 已在 <a href="https://github.com/woshichenghaibo/creditcards" target="_blank" rel="noopener noreferrer" class="text-blue-500 underline">Github</a> 开源
            </div>
    ...
    <script>
        ...
        function renderSummaryStats(cardsWithDates) {
            ...
            stats.dueIn7.textContent = \`\${dueIn7} 行\`;
            if (dueIn7 > 0) {
        ...
        function renderCardList(cardsWithDates) {
            ...
            cardsWithDates.forEach(card => {
                ...
                row.className = 'bg-gray-50 p-3 rounded-lg grid grid-cols-10 gap-0.5 items-center text-xs';
